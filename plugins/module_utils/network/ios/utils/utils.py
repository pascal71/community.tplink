...
def normalize_interface(name):
    ...
    if if_type:
        proper_interface = if_type + " " + number_list[1].strip()
    else:
        proper_interface = name

    out.write("Proper Interface type %s: \n" % if_type)
    out.write("proper_interface name \'%s\'\n" % proper_interface)
    proper_interface.strip()
    proper_interface.strip('#')
    out.write("proper_interface name \'%s\'\n" % proper_interface)
