...
class L2_Interfaces(ConfigBase):
    ...
    access_cmds = {"access_vlan": "switchport pvid"}
    voice_cmds = {"voice_vlan": "voice vlan"}
    trunk_cmds = {
    ...
    def _set_config(self, want, have, module):
        ...
        if diff:
            ...
            if access:
                cmd = "switchport pvid {0}".format(access[0][1])
            ...
            if want_trunk:
                ...
                if allowed_vlans and self._check_for_correct_vlan_range(
                    ...
                    if allowed_vlans:
                        ...
                        cmd = trunk_cmd + " {0} tagged".format(allowed_vlans)
                        add_command_to_config_list(interface, cmd, commands)
