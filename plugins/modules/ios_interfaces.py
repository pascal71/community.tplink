...
options:
  config:
    ...
    suboptions:
      name:
        description:
        - Full name of interface, e.g. gigabitEthernet 1/0/2, loopback 999.
        type: str
        required: true
      description:
        description:
...
from ansible_collections.community.tplink.plugins.module_utils.network.ios.config.interfaces.interfaces import (
    Interfaces,
)
