...
- name: Merge provided configuration with device configuration
  community.tplink.ios_l2_interfaces:
    config:
...
from ansible_collections.community.tplink.plugins.module_utils.network.ios.config.l2_interfaces.l2_interfaces import (
    L2_Interfaces,
)
