...
from ansible_collections.community.tplink.plugins.module_utils.network.ios.argspec.vlans.vlans import (
    VlansArgs,
)
from ansible_collections.community.tplink.plugins.module_utils.network.ios.config.vlans.vlans import (
    Vlans,
)
