...
- name: Merge provided configuration with device configuration
  community.tplink.ios_l3_interfaces:
    config:
...
from ansible_collections.community.tplink.plugins.module_utils.network.ios.config.l3_interfaces.l3_interfaces import (
    L3_interfaces,
)
